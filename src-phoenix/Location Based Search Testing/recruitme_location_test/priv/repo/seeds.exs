...
#
#     RecruitmeLocationTest.Repo.insert!(%RecruitmeLocationTest.SomeModel{})
#
...
Enum.each(user_params, fn(params) ->
  RecruitmeLocationTest.User.changeset(%RecruitmeLocationTest.User{}, params)
  |> RecruitmeLocationTest.Repo.insert!()
end)