defmodule RecruitmeLocationTest.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import RecruitmeLocationTest.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&RecruitmeLocationTest.ErrorHelpers.translate_error/1)
